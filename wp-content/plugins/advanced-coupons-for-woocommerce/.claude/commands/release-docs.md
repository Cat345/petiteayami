...
If `--tag` was provided, use it. Otherwise ask: *"What tag are you preparing? (e.g. v4.0.8)"* — keep it as a plain string; do not create the git tag.
...
Affected docs sections:
  ...
  - features      (1 file changed: Models/Cashback_Coupon.php)
```
