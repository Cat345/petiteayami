...
if ( ! class_exists( 'WC_Report_Upsells_By_Product' ) ) {
	/**
	...
	class WC_Report_Upsells_By_Product extends WC_Admin_Report {
		...
		public function products_widget() {
			...
			<div class="section">
				<form method="GET">
					<div>
						<select class="wc-product-search" style="width:203px;" multiple="multiple" id="product_ids" name="product_ids[]" data-placeholder="<?php esc_attr_e( 'Search for a product&hellip;', 'woocommerce' ); ?>" data-action="wfocu_accepted_product_search" data-nonce="<?php echo esc_attr( wp_create_nonce( 'wcfou_accepted_product_search' ) ); ?>"></select>
			...
			<div class="section">
				<table cellspacing="0">
					<?php
					$top_upsells = WFOCU_Core()->track->query_results(
						array(
							'data'        => array(
								'object_id'      => array(
									'type'     => 'col',
			...
			<div class="section">
				<table cellspacing="0">
					<?php
					$top_earners = WFOCU_Core()->track->query_results(
						array(
							'data'        => array(
								'object_id' => array(
									'type'     => 'col',
		...
		public function upsells_sparkline( $object_id = '', $days = 7, $type = 'upsells' ) {
			...
			$sparks_data = WFOCU_Core()->track->query_results(
				array(
					'data'        => array(
						'value'          => array(
							'type'     => 'col',
