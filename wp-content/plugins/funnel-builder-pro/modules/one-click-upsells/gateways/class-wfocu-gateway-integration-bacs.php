...
if ( ! class_exists( 'WFOCU_Gateway_Integration_Bacs' ) ) {
	...
	class WFOCU_Gateway_Integration_Bacs extends WFOCU_Gateway {
		...
		public function __construct() {
			...
			/**
			 * Hook into BACS payment processing to setup upsell
			 */
			add_filter( 'woocommerce_bacs_process_payment_order_status', array( $this, 'maybe_setup_upsell_for_bacs' ), 999, 2 );
		...
		/**
		 * Setup upsell for BACS payments and set primary order status
		 *
		 ...
		 * @return string
		 */
		public function maybe_setup_upsell_for_bacs( $order_status, $order ) {
