            ...
            <div class="wfocu-col-md-12">
                <div class="wfocu-progressbar-sec-wrap wfocu-max-845">
                    <div class="wfocu-progressbar  wfocu-clearfix">
                        <span class="wfocu-pstep wfocu-completed step1"><?php echo esc_html( $step_1_text ); ?></span>
                        <span class="wfocu-pstep wfocu-active step2"><?php echo esc_html( $step_2_text ); ?></span>
                        <span class="wfocu-pstep step3"><?php echo esc_html( $step_3_text ); ?></span>
                    </div>
                </div>
            </div>
        </div>
