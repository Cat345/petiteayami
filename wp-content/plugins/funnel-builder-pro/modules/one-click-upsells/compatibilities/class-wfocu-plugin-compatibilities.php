	...
	class WFOCU_Plugin_Compatibilities {
		...
		public static function load_all_compatibilities() {
			...
			$paths = array(
				...
				'class-wfocu-compatibility-with-yith-currency-switcher.php' => defined( 'YITH_WCMCS_VERSION' ),
				...
				'class-wfocu-plugin-integration-econt.php' => defined( 'ECONT_PLUGIN_DIR' ) || class_exists( 'Econt_Express' ),
