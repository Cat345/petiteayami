	...
	class WFOCU_Quantity_Selector extends WFOCU_Divi_HTML_BLOCK {
		...
		public function setup_data() {
			...
			if ( false === $qty_selector_enabled ) {
				$this->add_subheading( $tab_id, __( 'The quantity selector is currently unavailable for this offer. Please enable customers to choose their preferred quantity when purchasing this upsell product(s) from the "Products" tab', 'woofunnels-upstroke-one-click-upsell' ) );
		...
		public function html( $attrs, $content = null, $render_slug = '' ) {
			...
			if ( ! empty( $product_key ) ) {
				echo "<div class=$class_name>"; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
