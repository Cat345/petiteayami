...
class WFOCU_Product_Title extends WFOCU_Component {
    static slug = 'et_wfocu_product_title';

    constructor() {
        super();
        this.ajax = true;
        this.c_slug = WFOCU_Product_Title.slug;
    }
...
export default WFOCU_Product_Title;