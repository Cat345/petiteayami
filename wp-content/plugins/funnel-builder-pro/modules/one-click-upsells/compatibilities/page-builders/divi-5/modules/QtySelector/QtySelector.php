...
use WFOCU\Modules\QtySelector\QtySelectorTrait\RenderCallbackTrait;
use WFOCU\Modules\QtySelector\QtySelectorTrait\ModuleClassnamesTrait;
use WFOCU\Modules\QtySelector\QtySelectorTrait\ModuleStylesTrait;
use WFOCU\Modules\QtySelector\QtySelectorTrait\ModuleScriptDataTrait;
use WFOCU\Modules\QtySelector\QtySelectorTrait\RestApiTrait;
...
$trait_dir = __DIR__ . '/QtySelectorTrait/';
$traits    = array(
...
/**
 * QtySelector module class.
 *
 * This class extends BaseModule and handles registration and rendering
 * of the Qty Selector module.
 *
 * @since 1.0.0
 */
#[\AllowDynamicProperties]
class QtySelector extends BaseModule {
	...
	protected function get_module_namespace(): string {
		return 'WFOCU\Modules\QtySelector';
	}
