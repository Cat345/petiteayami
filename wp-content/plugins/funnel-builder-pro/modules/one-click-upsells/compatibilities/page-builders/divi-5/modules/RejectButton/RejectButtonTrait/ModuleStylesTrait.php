...
use WFOCU\Modules\RejectButton\RejectButtonTrait\CustomCssTrait;
...
trait ModuleStylesTrait {
	...
	/**
	 * Reject Button module's style components.
	 *
	 * This function is equivalent of JS function ModuleStyles located in
	 * src/components/reject-button/styles.tsx.
	 *
	 * @since 1.0.0
	 *
	 * @param array $args {
	...
	public static function module_styles( array $args ): void {
		...
		if ( class_exists( 'ET\Builder\Packages\ModuleLibrary\ModuleRegistration' ) ) {
			try {
				$default_attrs = ModuleRegistration::get_default_attrs( 'wfocu/reject-button' );
			} catch ( \Exception $e ) {
		...
		Style::add(
			array(
				...
				'styles'        => array(
					...
					// Reject Button Color - Background Color
					// Selector: {{selector}} .wfocu-reject-button-wrap .wfocu-wfocu-reject
					$elements->style(
						array(
							'attrName' => 'wfocu_reject_button_background_color',
						)
					),
					// Reject Button Color - Background Hover Color
					// Selector: {{selector}} .wfocu-reject-button-wrap .wfocu-wfocu-reject:hover
					$elements->style(
						array(
							'attrName' => 'wfocu_reject_button_background_hover_color',
						)
					),
					// Reject Button Color - Text Hover Color
					// Selector: {{selector}} .wfocu-reject-button-wrap .wfocu-wfocu-reject:hover .wfocu-button-text
					$elements->style(
						array(
							'attrName' => 'wfocu_reject_button_text_hover_color',
						)
					),
					// Reject Button Color - Text Color
					// Selector: {{selector}} .wfocu-reject-button-wrap .wfocu-wfocu-reject
					$elements->style(
						array(
							'attrName' => 'wfocu_reject_button_text_color',
						)
					),
					// Icon Spacing - Icon Spacing
					// Selector: {{selector}} .wfocu-button-wrapper .wfocu-button-icon
					$elements->style(
						array(
							'attrName' => 'icon_margin',
						)
					),
