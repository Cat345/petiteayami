...
use WFOCU\Modules\AcceptLink\AcceptLinkTrait\RenderCallbackTrait;
use WFOCU\Modules\AcceptLink\AcceptLinkTrait\ModuleClassnamesTrait;
use WFOCU\Modules\AcceptLink\AcceptLinkTrait\ModuleStylesTrait;
use WFOCU\Modules\AcceptLink\AcceptLinkTrait\ModuleScriptDataTrait;
use WFOCU\Modules\AcceptLink\AcceptLinkTrait\RestApiTrait;
...
$trait_dir = __DIR__ . '/AcceptLinkTrait/';
$traits    = array(
...
/**
 * AcceptLink module class.
 *
 * This class extends BaseModule and handles registration and rendering
 * of the Accept Link module.
 *
 * @since 1.0.0
 */
class AcceptLink extends BaseModule {
	...
	protected function get_module_namespace(): string {
		return 'WFOCU\Modules\AcceptLink';
	}
