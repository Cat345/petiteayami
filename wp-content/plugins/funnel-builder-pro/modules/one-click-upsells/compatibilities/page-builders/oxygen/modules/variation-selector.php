...
if ( ! class_exists( 'WFOCU_Oxy_Variation_Selector' ) ) {
	...
	class WFOCU_Oxy_Variation_Selector extends WFOCU_Oxy_HTML_BLOCK {
		...
		public function setup_data() {
			...
			$this->slider_measure_box( $tab_id, $this->slug . '_space_btw_attributes', '.wfocu-product-attr-wrapper .variations tr', __( 'Spacing', 'woofunnels-upstroke-one-click-upsell' ), '2', array(), $property_css );
