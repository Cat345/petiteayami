	...
	<div class="wfob_bgBox_table">
		<div class="wfob_bump_title_start">
			...
			<div class="wfob_checkbox_input_wrap">
				<?php
				require WFOB_SKIN_DIR . '/template-parts/wfob-pointer.php';
				?>
				<span class="wfob_bump_checkbox">
				<input type="checkbox" name="<?php echo esc_attr( $product_key ); ?>" id="<?php echo esc_attr( $product_key ); ?>" data-value="<?php echo esc_attr( $product_key ); ?>" class="wfob_checkbox wfob_bump_product <?php echo esc_attr( $checkbox_class ); ?>" <?php echo '' != $cart_item_key ? 'checked' : ''; ?> <?php echo esc_attr( $disabled ); ?>>
		...
		require WFOB_SKIN_DIR . '/template-parts/wfob-social-proof-tool-tip.php';
