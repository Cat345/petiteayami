...
if ( ! class_exists( 'WFOB_Compatibility_With_WC_Checkout_addons' ) ) {
	...
	class WFOB_Compatibility_With_WC_Checkout_addons {
		...
		public function __construct() {
			add_action( 'wfob_order_bump_fragments', array( $this, 'remove_add_on_fragments' ) );
		}

		public function remove_add_on_fragments() {
			add_filter( 'woocommerce_update_order_review_fragments', array( $this, 'remove_fragments_from_bump_calls' ), 999 );
		}
