...
if ( ! class_exists( 'WFOB_Plugin_Compatibilities' ) ) {
	...
	class WFOB_Plugin_Compatibilities {
		...
		public static function load_all_compatibilities() {
			add_action( 'after_setup_theme', array( __CLASS__, 'frontend_compatibility' ) );
		}
		...
		public static function frontend_compatibility() {
			$files = array(
				...
				'class-subscriptions.php'                  => class_exists( 'WC_Subscriptions' ),
				...
				'class-wfob-compatibility-wpc-variations-radio-buttons.php' => class_exists( 'WPClever_Woovr' ),
				...
				'class-wfob-compatibility-woocommerce-product-bundles.php' => function_exists( 'WC_PB' ),
				...
				'woocommerce-paypal-payments.php'          => defined( 'PPCP_PAYPAL_BN_CODE' ),
