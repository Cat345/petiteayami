...
if ( ! class_exists( 'WFACP_WooCommerce_Chained_Products' ) ) {
	...
	class WFACP_WooCommerce_Chained_Products {
		...
		public function __construct() {
			...
			add_action( 'wfacp_before_process_checkout_template_loader', array( $this, 'action' ), 1 );
			add_filter( 'wfacp_product_raw_data', array( $this, 'change_raw_data' ), 999, 2 );
			add_filter( 'wfacp_force_calculate_discount', array( $this, 'force_discount' ), 999, 2 );
		}
