...
if ( ! class_exists( 'WFACP_Compatibility_With_Theme_Brick' ) ) {
	...
	class WFACP_Compatibility_With_Theme_Brick {
		...
		public function __construct() {
			...
			add_action( 'wfacp_update_page_design', [ $this, 'update_page_template' ], 99, 1 );
			...
			add_action( 'wfacp_template_load', [ $this, 'fix_bricks_header_post_override' ] );
		}
		...
		public function fix_bricks_header_post_override() {
			...
			add_action( 'bricks_after_header', [ $this, 'restore_checkout_post_context' ], 1 );
		}
		...
		public function restore_checkout_post_context() {
			...
			if ( ! has_filter( 'the_content', [ $this, 'force_checkout_content' ] ) ) {
				add_filter( 'the_content', [ $this, 'force_checkout_content' ], 10 );
			}
		}
		...
		public function force_checkout_content( $content ) {
			...
			remove_filter( 'the_content', [ $this, 'force_checkout_content' ], 10 );
