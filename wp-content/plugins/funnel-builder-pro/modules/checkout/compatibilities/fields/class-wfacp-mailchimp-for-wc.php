...
if ( ! class_exists( 'WFACP_Compatibility_Mailchimp_For_WC' ) ) {
	...
	class WFACP_Compatibility_Mailchimp_For_WC {
		...
		public function __construct() {
			add_filter( 'wfacp_template_load', array( $this, 'add_action' ), 20 );
			/* Register Add field */
		...
		public function add_field( $fields ) {
			...
			$fields['wfacp_mailchimp_for_wc'] = array(
				'type'       => 'wfacp_html',
				'class'      => array( 'wfacp-col-full', 'wfacp-form-control-wrapper', 'wfacp_mailchimp_for_wc' ),
