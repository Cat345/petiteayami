...
if ( ! class_exists( 'WFACP_RY_WC_Ecpay' ) ) {
	...
	class WFACP_RY_WC_Ecpay {
		...
		public function __construct() {
			...
			/* Assign Object */
			add_action( 'wfacp_after_checkout_page_found', array( $this, 'action' ), 99 );
			/* default classes */
		...
		public function add_field( $fields ) {
			$fields['rc_wc_ecpay'] = array(
				'type'       => 'wfacp_html',
				'class'      => array( 'wfacp-col-full', 'wfacp-form-control-wrapper', 'rc_wc_ecpay' ),
				'id'         => 'rc_wc_ecpay',
