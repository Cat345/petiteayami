...
if ( ! class_exists( 'WFACP_Compatibility_WC_Taxamo' ) ) {
	...
	class WFACP_Compatibility_WC_Taxamo {
		...
		public function __construct() {
			...
			add_action( 'process_wfacp_html', array( $this, 'display_field' ), 12, 2 );

			/* Assign Object */
			add_action( 'wfacp_after_checkout_page_found', array( $this, 'action' ) );

			/* default classes */
			add_filter( 'woocommerce_form_field_args', array( $this, 'add_default_styling' ), 13, 2 );
		...
		public function add_field( $fields ) {
			$fields['wc_taxamo_vat_number'] = array(
				'type'       => 'wfacp_html',
				'class'      => array( 'wfacp-col-full', 'wfacp-form-control-wrapper', 'wfacp_wc_taxamo_vat_number' ),
