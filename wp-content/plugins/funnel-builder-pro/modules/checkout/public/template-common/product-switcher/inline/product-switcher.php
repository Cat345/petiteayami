...
$page_settings          = WFACP_Common::get_page_product_settings( $wfacp_id );
...
if ( is_array( $products ) && count( $products ) > 0 ) {
	...
	?>
	<div class="wfacp_anim wfacp_pro_switch wfacp_inline_ps <?php echo $deviceType; ?>shop_table wfacp-product-switch-panel <?php echo $classes . ' ' . $ps_setting_wrapper_class . ' wfacp_type_' . $type; ?>" cellspacing="0" id="product_switching_field" <?php echo WFACP_Common::get_fragments_attr(); ?> >
		<?php
