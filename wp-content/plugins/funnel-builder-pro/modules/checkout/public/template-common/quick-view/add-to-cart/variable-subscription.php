					...
					<?php foreach ( $attributes as $attribute_name => $options ) : ?>
						<tr>
							...
							<td class="value">
								...
								WFACP_Common::wc_dropdown_variation_attribute_options(
									array(
										'options'   => $options,
								...
								echo wp_kses(
									end( $attribute_keys ) === $attribute_name ? apply_filters( 'woocommerce_reset_variations_link', '<a class="reset_variations" href="#">' . __( 'Clear', 'woocommerce-subscriptions' ) . '</a>' ) : '',
									array(
										'a' => array(
											'class' => array(),
											'href'  => array(),
