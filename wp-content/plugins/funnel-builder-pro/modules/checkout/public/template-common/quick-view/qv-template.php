...
add_action( 'wfacp_qv_summary', array( WFACP_Core()->public, 'woocommerce_template_single_excerpt' ), 20 );
add_action( 'wfacp_qv_summary', array( WFACP_Core()->public, 'woocommerce_template_single_add_to_cart' ), 25 );
add_action(
	'wfacp_qv_summary',
	function () {
...
if ( is_null( $wfacp_product ) ) {
	add_action( 'wfacp_woocommerce_variable_add_to_cart', array( WFACP_Core()->public, 'woocommerce_variable_add_to_cart' ) );
	add_action( 'wfacp_woocommerce_variable-subscription_add_to_cart', array( WFACP_Core()->public, 'woocommerce_variable_subscription_add_to_cart' ) );
}
...
<div id="wfacp_qr_model_wrap" class=" wfacp_qv-inner-modal <?php echo $productType; ?>" data-item-key="<?php echo $item_key; ?>" data-cart-key="<?php echo $cart_key; ?>">
	<div class="wfacp_qv-container woocommerce single-product">
		...
		<div class="wfacp_qv-main1">
			<div id="product-<?php echo $product->get_id(); ?>" <?php post_class( 'product wfacp_qv_sec' ); ?>>
				<div class="wfacp_qr_wrap">
