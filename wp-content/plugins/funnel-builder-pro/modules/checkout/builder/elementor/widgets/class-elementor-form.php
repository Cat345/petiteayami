...
if ( ! class_exists( 'El_WFACP_Form_Widget' ) ) {
	...
	class El_WFACP_Form_Widget extends WFACP_Elementor_HTML_BLOCK {
		...
		private function order_summary_fields() {
			...
			$this->add_switcher( 'order_summary_enable_product_image', __( 'Enable Image', 'woofunnels-aero-checkout' ), '', '', 'yes', 'yes', array(), '', '', 'wfacp_elementor_device_hide' );
		...
		private function form_buttons() {
			...
			for ( $i = 1; $i <= $count; $i++ ) {
				...
				$this->add_text( $button_key, __( 'Button Text', 'woofunnels-aero-checkout' ), esc_js( $button_default_text ), array(), 'wfacp_field_text_wrap' );

				$this->icon_text( $text_key );

				if ( $i == $count ) {
					$this->add_switcher_without_responsive( 'enable_price_in_place_order_button', __( 'Enable Price', 'woofunnels-aero-checkout' ), '', '', 'no', 'yes', array() );
			...
			$this->add_text( 'text_below_placeorder_btn', __( 'Text Below Place Order Button', 'woofunnels-aero-checkout' ), sprintf( 'We Respect Your Privacy & Information ', 'woofunnels-aero-checkout' ), array(), 'wfacp_field_text_wrap wfacp_bold' );
			$this->ajax_session_settings[] = 'text_below_placeorder_btn';
		}

		private function icon_text( $counter_step ) {

			$this->add_text( 'step_' . $counter_step . '_text_after_place_order', __( ' Sub Text', 'woofunnels-aero-checkout' ), '', array(), 'wfacp_field_text_wrap' );
			$icon_list = array(
			...
			$this->add_switcher_without_responsive( 'enable_icon_with_place_order_' . $counter_step, __( 'Enable Icon', 'woofunnels-aero-checkout' ), '', '', 'no', 'yes', array() );
		...
		private function mobile_mini_cart() {
			...
			$enable_callapse_order_summary_device = array(
				'tablet' => array(
					'condition' => array(
						'enable_callapse_order_summary_tablet' => array( 'yes' ),
					),
				),
				'mobile' => array(
					'condition' => array(
						'enable_callapse_order_summary_mobile' => array( 'yes' ),
					),
				),
			);

			$this->add_switcher( 'enable_callapse_order_summary', __( 'Enable', 'woofunnels-aero-checkout' ), '', '', 'no', 'yes', array(), '', '' );
			$this->add_switcher( 'enable_order_field_collapsed', __( 'Expanded Order Summary', 'woofunnels-aero-checkout' ), '', '', 'no', 'yes', array(), '', '' );

			$this->add_switcher_without_responsive( 'order_summary_enable_product_image_collapsed', __( 'Enable Image', 'woofunnels-aero-checkout' ), '', '', 'yes', 'yes', array(), '', '', 'wfacp_elementor_device_hide' );
			...
			$this->ajax_session_settings[] = 'enable_callapse_order_summary_mobile';
			...
			$this->price_strike_through_content_settings( 'collapsible_mini_cart' );
		...
		private function collapsible_summary_coupon() {
			...
			$this->add_typography( $field_key . '_input_typo', $optionString, array(), $condition, __( 'Coupon Typography' ) );
		...
		public function get_progress_settings() {
			...
			$this->add_border_color( 'progress_bar_circle_color', array( '{{WRAPPER}} #wfacp-e-form .wfacp_custom_breadcrumb .wfacp_steps_sec ul li:before' ), '', __( 'Circle Border', 'woofunnels-aero-checkout' ), false, $progress_bar_condition );
			...
			$this->add_border_color( 'active_tab_border_bottom_color', array( '{{WRAPPER}} #wfacp-e-form .wfacp-payment-tab-list.wfacp-active' ), '', __( 'Tab Border Color', 'woofunnels-aero-checkout' ), false, $tab_condition );
			...
			if ( $number_of_steps > 1 ) {
				...
				$this->add_border_color( 'active_step_count_border_color', array( '{{WRAPPER}} #wfacp-e-form .wfacp_form_steps .wfacp-payment-tab-list.wfacp-active .wfacp-order2StepNumber' ), '', __( 'Count Border Color', 'woofunnels-aero-checkout' ), false, $tab_condition );
			...
			$this->add_color( 'inactive_step_text_color', array( '{{WRAPPER}} #wfacp-e-form .wfacp_form_steps .wfacp-payment-tab-list .wfacp_tcolor' ), '', __( 'Text Color', 'woofunnels-aero-checkout' ), $tab_condition );
			$this->add_border_color( 'inactive_tab_border_bottom_color', array( '{{WRAPPER}} #wfacp-e-form .wfacp-payment-tab-list' ), '', __( 'Tab Border Color', 'woofunnels-aero-checkout' ), false, $tab_condition );
			...
			$this->add_border_color( 'inactive_step_count_border_color', array( '{{WRAPPER}} #wfacp-e-form .wfacp_form_steps .wfacp-payment-tab-list .wfacp-order2StepNumber' ), '', __( 'Count Border Color', 'woofunnels-aero-checkout' ), false, $tab_condition );
		...
		private function fields_typo_settings() {
			...
			// Label color includes all label elements including checkbox/radio labels
			// Issue #8209: Checkbox labels should be controlled by label color, not input color
			$form_fields_label_color_opt = array(
			...
			// Input typography for actual input fields (excluding checkbox/radio labels)
			// Issue #8209: Checkbox labels controlled by label typography, not input typography
			$fields_options = array(
			...
			// Input color controls input field text, NOT checkbox/radio labels
			// Issue #8209: Checkbox labels removed from here, now controlled by label color
			$inputColorOption = array(
		...
		private function payment_method() {
			...
			$this->add_text( 'wfacp_payment_method_heading_text', __( 'Heading', 'woofunnels-aero-checkout' ), __( 'Payment', 'woocommerce' ), array(), 'wfacp_field_text_wrap' );

			$this->add_textArea( 'wfacp_payment_method_subheading', __( 'Sub heading', 'woofunnels-aero-checkout' ), esc_attr__( 'All transactions are secure and encrypted.', 'woofunnels-aero-checkout' ) );
		...
		private function payment_buttons_styling() {
			...
			$this->add_switcher( 'wfacp_make_button_sticky_on_mobile', __( 'Sticky on Mobile', 'woofunnels-aero-checkout' ), '', '', 'no', 'yes', array(), '', '', 'wfacp_elementor_device_hide' );
		...
		private function global_typography() {
			...
			$globalSettingOptions = array(
				...
				// Section Heading selectors (from get_heading_settings)
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce .wfacp_section_title',
				// Sub Heading selectors (from get_heading_settings)
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce .wfacp-comm-title h4',
				// Fields Label selectors (from fields_typo_settings)
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce p.wfacp-form-control-wrapper label.wfacp-form-control-label',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce .create-account label',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce .create-account label span',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce p.wfacp-form-control-wrapper:not(.wfacp-anim-wrap) label.wfacp-form-control-label abbr',
				...
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce .form-row label.checkbox',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce .form-row label.checkbox *',
				// Fields Input selectors (from fields_typo_settings)
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="text"]',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="email"]',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="tel"]',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="password"]',
				...
				'{{WRAPPER}} #wfacp-e-form .woocommerce-input-wrapper .wfacp-form-control',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce .select2-container .select2-selection--single .select2-selection__rendered',
				// Placeholder selectors for font family
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="text"]::placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="text"]::-webkit-input-placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="text"]::-moz-placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="text"]:-ms-input-placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="email"]::placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="email"]::-webkit-input-placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="email"]::-moz-placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="email"]:-ms-input-placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="tel"]::placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="tel"]::-webkit-input-placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="tel"]::-moz-placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="tel"]:-ms-input-placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="password"]::placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="password"]::-webkit-input-placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="password"]::-moz-placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="password"]:-ms-input-placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="number"]::placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="number"]::-webkit-input-placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="number"]::-moz-placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce input[type="number"]:-ms-input-placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce textarea::placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce textarea::-webkit-input-placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce textarea::-moz-placeholder',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce textarea:-ms-input-placeholder',
				'{{WRAPPER}} #wfacp-e-form .woocommerce-input-wrapper .wfacp-form-control::placeholder',
				'{{WRAPPER}} #wfacp-e-form .woocommerce-input-wrapper .wfacp-form-control::-webkit-input-placeholder',
				'{{WRAPPER}} #wfacp-e-form .woocommerce-input-wrapper .wfacp-form-control::-moz-placeholder',
				'{{WRAPPER}} #wfacp-e-form .woocommerce-input-wrapper .wfacp-form-control:-ms-input-placeholder',
				// Payment Button selectors (from payment_buttons_styling)
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce #payment button#place_order',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce  button#place_order',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce  .wfacp_payment #ppcp-hosted-fields .button',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce .woocommerce-checkout button.button.button-primary.wfacp_next_page_button',
				// Payment Method selectors (from payment_method_styling)
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce .wfacp_payment #payment .payment_methods p',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce .wfacp_payment #payment .payment_methods label',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce .wfacp_payment #payment .payment_methods span',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce .wfacp_payment #payment .payment_methods p a',
				...
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce .wfacp_payment #payment .payment_methods input',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce .wfacp_payment #add_payment_method #payment .payment_box p',
				// Tab/Steps Heading selectors (from get_progress_settings)
				'{{WRAPPER}} #wfacp-e-form .wfacp_form_steps .wfacp-order2StepTitle.wfacp-order2StepTitleS1',
				// Tab/Steps Subheading selectors (from get_progress_settings)
				'{{WRAPPER}} #wfacp-e-form .wfacp_form_steps .wfacp-order2StepSubTitle.wfacp-order2StepSubTitleS1',
				// Progress Bar Heading selectors (from get_progress_settings)
				'{{WRAPPER}} #wfacp-e-form .wfacp_custom_breadcrumb .wfacp_steps_sec ul li a',
				// Breadcrumb Heading selectors (from get_progress_settings)
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce .wfacp_steps_sec ul li a',
				// Collapsible Coupon selectors (from collapsible_summary_coupon)
				'{{WRAPPER}} #wfacp-e-form .wfacp_woocommerce_form_coupon .wfacp-coupon-section .woocommerce-info span',
				'{{WRAPPER}} #wfacp-e-form .wfacp_main_form.woocommerce .wfacp_woocommerce_form_coupon .wfacp-coupon-section .woocommerce-info .wfacp_showcoupon',
				'{{WRAPPER}} #wfacp-e-form form.checkout_coupon.woocommerce-form-coupon .wfacp-col-left-half label.wfacp-form-control-label',
				'{{WRAPPER}} #wfacp-e-form form.checkout_coupon.woocommerce-form-coupon .wfacp-col-left-half .wfacp-form-control',
			...
			$primary_color = array(
				...
				'{{WRAPPER}} #wfacp-e-form  button[type=button]:not(.white):not(.black):not(.wfacp-upload-delete)',
		...
		private function collapsible_order_summary() {
			...
			$this->add_color(
				...
				array(
					...
					'{{WRAPPER}} #wfacp-e-form .wfacp_mb_cart_accordian .wfacp_show_price_wrap *',
					'{{WRAPPER}} #wfacp-e-form .wfacp_mb_cart_accordian .wfacp_show_price_wrap span bdi',
		...
		private function class_section() {
			...
			foreach ( $sections as $keys => $val ) {
				foreach ( $val as $loop_key => $field ) {
					...
					$this->add_text( 'wfacp_' . $template_slug . '_' . $field_key . '_field_class', __( $field['label'], 'woofunnels-aero-checkout' ), '', array(), '', '', 'Custom Class' );
		...
		private function privacy_policy_styling() {
			...
			$this->add_font_size( 'wfacp_privacy_policy_font_size', implode( ',', $typo ), 'Font Size (in px)', $default, array(), array( 'px' ), $default, $default );
