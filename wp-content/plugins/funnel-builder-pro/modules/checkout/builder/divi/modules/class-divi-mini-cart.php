...
if ( ! class_exists( 'WFACP_Divi_Summary' ) ) {
	...
	class WFACP_Divi_Summary extends WFACP_Divi_HTML_BLOCK {
		...
		protected function mini_cart() {
			...
			$this->add_text( $coupon_tab_id, 'mini_cart_coupon_button_text', __( 'Coupon Button Text', 'woofunnels-aero-checkout' ), __( 'Apply', 'woocommerce' ), array( 'enable_coupon' => 'on' ) );
			...
			$this->add_switcher( $coupon_tab_id, 'enable_coupon_collapsible', __( 'Collapsible', 'woofunnels-aero-checkout' ), 'off', array( 'enable_coupon' => 'on' ) );
			...
			$this->add_typography( $heading_tab_id, 'mini_cart_section_typo', '%%order_class%% .wfacp_mini_cart_start_h .wfacp-order-summary-label', '', '', array(), $font_side_default, $letterSpacing );
			$this->add_color( $heading_tab_id, 'mini_cart_section_text_color', array( '%%order_class%% .wfacp-order-summary-label' ), '', '#333' );
			$this->add_text_alignments( $heading_tab_id, 'mini_cart_section_typo_alignment', array( '%%order_class%% .wfacp-order-summary-label' ) );
			...
			$this->add_typography( $cart_id, 'mini_cart_product_typo', implode( ',', $mini_cart_product_typo ), '', '', array(), $font_side_default );

			$this->add_color( $cart_id, 'mini_cart_product_color', $mini_cart_product_typo, '', '#666666' );

			$this->add_border_color( $cart_id, 'mini_cart_product_image_border_color', array( '%%order_class%% .wfacp_mini_cart_start_h .wfacp_order_sum .product-image img' ), '', __( 'Image Border Color', 'woofunnel-aero-checkout' ), false );

			$this->add_border_radius( $cart_id, 'mini_cart_item_border_radius', array( '%%order_class%% .wfacp_mini_cart_start_h .wfacp_order_sum .product-image img' ) );
			...
			$font_side_default1 = array(
				'default' => '15px',
				'unit'    => 'px',
			);
			$this->add_typography( $coupon_css_tab_id, 'mini_cart_coupon_heading_typo', '%%order_class%% .wfacp_mini_cart_start_h .wfacp-coupon-section .wfacp-coupon-page .wfacp_main_showcoupon', array(), '', $enable_coupon_collapsible, $font_side_default1 );
			$this->add_color(
				$coupon_css_tab_id,
			...
			$this->add_typography( $coupon_css_tab_id, 'wfacp_form_mini_cart_coupon_label_typo', implode( ',', $form_fields_label_typo ), __( 'Label Typography', 'woofunnels-aero-checkout' ), $fields_options, array(), $font_side_default );
			...
			$this->add_color( $coupon_css_tab_id, 'wfacp_form_fields_label_color', $form_fields_label_color_opt, __( 'Label Color', 'woofunnels-aero-checkout' ), '', array() );

			$fields_options = array(
				'%%order_class%% .wfacp_mini_cart_start_h form.checkout_coupon.woocommerce-form-coupon .wfacp-form-control',
			);

			$this->add_heading( $coupon_css_tab_id, __( 'Input Field', 'woofunnel-aero-checkout' ), 'none', array() );
			...
			$this->add_typography( $coupon_css_tab_id, 'wfacp_form_mini_cart_coupon_input_typo', $optionString, __( 'Coupon Typography' ), array(), array(), $font_side_default );

			$inputColorOption = array(
				'%%order_class%% .wfacp_mini_cart_start_h form.checkout_coupon.woocommerce-form-coupon .wfacp-form-control',
			);
			$this->add_color( $coupon_css_tab_id, 'wfacp_form_mini_cart_coupon_input_color', $inputColorOption, '', __( 'Coupon Color', 'woofunnels-aero-checkout' ), array() );
			...
			$this->add_border( $coupon_css_tab_id, 'wfacp_form_mini_cart_coupon_border', implode( ',', $fields_options ), array(), $default );

			/* Coupon focus Input Color tab */
			$coupon_focus_tab_id = $this->add_tab( __( 'Coupon focus Input Color', 'woofunnels-aero-checkout' ), 2 );
			$this->add_border_color( $coupon_focus_tab_id, 'wfacp_form_mini_cart_coupon_focus_color', array( '%%order_class%% .wfacp_mini_cart_start_h form.checkout_coupon.woocommerce-form-coupon .wfacp-form-control:focus' ), '', __( 'Focus border color', 'woofunnel-aero-checkout' ), true, array() );

			/* Field Label */

			$this->add_heading( $coupon_css_tab_id, __( 'Button', 'woofunnel-aero-checkout' ), '', array() );
			/* Button color setting */
			$control_id = $this->add_controls_tabs( $coupon_css_tab_id, '', array() );
			$fields     = array();
			$fields[]   = $this->add_background_color( $coupon_css_tab_id, 'mini_cart_coupon_btn_color', array( '%%order_class%% .wfacp_mini_cart_start_h button.wfacp-coupon-btn:not([disabled])' ), '#000000', __( 'Background', 'woofunnels-aero-checkout' ) );
			$fields[]   = $this->add_color( $coupon_css_tab_id, 'mini_cart_coupon_btn_lable_color', array( '%%order_class%% .wfacp_mini_cart_start_h button.wfacp-coupon-btn:not([disabled])' ), __( 'Label', 'woofunnels-aero-checkout' ) );
			$this->add_controls_tab( $control_id, 'Normal', $fields );

			$fields   = array();
			$fields[] = $this->add_background_color( $coupon_css_tab_id, 'mini_cart_coupon_btn_lable_hover_color', array( '%%order_class%% .wfacp_mini_cart_start_h button.wfacp-coupon-btn:not([disabled]):hover' ), __( 'Background', 'woofunnels-aero-checkout' ) );
			$fields[] = $this->add_color( $coupon_css_tab_id, 'mini_cart_coupon_btn_hover_label_color', array( '%%order_class%% .wfacp_mini_cart_start_h button.wfacp-coupon-btn:not([disabled]):hover' ), __( 'Label', 'woofunnels-aero-checkout' ) );
			$this->add_controls_tab( $control_id, 'Hover', $fields );

			$this->add_typography( $coupon_css_tab_id, 'wfacp_form_mini_cart_coupon_button_typo', '%%order_class%% .wfacp_mini_cart_start_h button.wfacp-coupon-btn', __( 'Button Typography' ), array(), array() );
			...
			$this->add_typography( $cart_id, 'mini_cart_product_meta_typo', implode( ',', $mini_cart_product_meta_typo ), '', '', array(), $font_side_default );
			...
			$this->add_typography( $cart_id, 'mini_cart_total_label_typo', implode( ', ', $cart_total_label_typo_option ), __( 'Label Typography', 'woofunnel-aero-checkout' ), '', array(), $font_side_default );
			$this->add_heading( $cart_id, __( 'Price Typography', 'woocommerce' ) );
			$this->add_typography( $cart_id, 'mini_cart_total_typo', implode( ', ', $cart_total_value_typo_option ), __( 'Price Typography', 'woofunnel-aero-checkout' ), '', array(), $font_side_default );
			...
			$this->add_background_color( $background_tab, 'mini_cart_background_color', array( '%%order_class%% .wfacp_mini_cart_start_h' ), '', 'Background Color' );
			...
			$this->add_border( $border_tab, 'mini_cart_border', '%%order_class%% .wfacp_mini_cart_start_h', array(), '', array(), $default_args );
			...
			$this->add_typography( $settings_tab_id, 'wfacp_mini_cart_font_family', implode( ',', $wfacp_mini_cart_font_family ), '', '', array(), $font_side_default );
