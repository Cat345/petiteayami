...
export const ModuleStyles = ({
  ...
  return (
    <StyleContainer mode={mode} state={state} noStyleTag={noStyleTag}>
      ...
      {/* Breadcrumb Typography - Heading (includes color from divi/font group — must come AFTER breadcrumb_text_color to win) */}
      {/* Selector: {{selector}} #wfacp-e-form .wfacp-form .wfacp_main_form.woocommerce .wfacp_steps_sec ul li a */}
      {elements.style({
      ...
      {elements.style({
        ...
        styleProps: {
          advancedStyles: (() => {
            ...
            // Detect this: all.width exists, is > 1px, and no explicit per-side overrides
            // → means D4 had a single-side width that got merged into all.
            ...
            if (needsWidthFix) {
              // Set top/left/right to D4 default 1px
              ...
              // Bottom: use the converted all.width (which is the D4 bottom value) or bottom.width
      ...
      {/* Selector: {{selector}} #wfacp-e-form .wfacp_main_form.woocommerce .wfacp-product-switch-panel fieldset.wfacp-selected-product .wfacp_product_price_sec span, ... */}
      {elements.style({
