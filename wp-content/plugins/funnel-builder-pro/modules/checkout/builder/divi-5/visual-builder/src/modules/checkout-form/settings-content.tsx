...
export const SettingsContent = ({
  ...
  const updatedGroupConfiguration = useMemo(() => {
    ...
    // Ensure collapsible_mini_cart_enable_strike_through_price toggle field exists (toggle field from module.json)
    if (!collapsibleFields.collapsible_mini_cart_enable_strike_through_price) {
      set(collapsibleFields, 'collapsible_mini_cart_enable_strike_through_price', {
        priority: 80,
        component: {
          name: 'divi/toggle',
          type: 'field',
        ...
        render: true,
        attrName: 'collapsible_mini_cart_enable_strike_through_price',
      ...
      collapsibleFields.collapsible_mini_cart_enable_strike_through_price.render = true;
    }

    // Ensure collapsible_mini_cart_enable_low_stock_trigger toggle field exists (toggle field from module.json)
    if (!collapsibleFields.collapsible_mini_cart_enable_low_stock_trigger) {
      set(collapsibleFields, 'collapsible_mini_cart_enable_low_stock_trigger', {
        priority: 90,
        component: {
          name: 'divi/toggle',
          type: 'field',
        ...
        render: true,
        attrName: 'collapsible_mini_cart_enable_low_stock_trigger',
      ...
      collapsibleFields.collapsible_mini_cart_enable_low_stock_trigger.render = true;
    }

    // Only show low stock message when low stock trigger is enabled
    const collapsibleLowStockEnabled = (attrs as any)?.collapsible_mini_cart_enable_low_stock_trigger?.desktop?.value === 'on';
    if (collapsibleLowStockEnabled) {
      if (collapsibleFields.collapsible_mini_cart_low_stock_message) {
        collapsibleFields.collapsible_mini_cart_low_stock_message.render = true;
      }
      if (collapsibleFields.collapsible_mini_cart_low_stock_messageInnercontent) {
        collapsibleFields.collapsible_mini_cart_low_stock_messageInnercontent.render = true;
      }
    } else {
      if (collapsibleFields.collapsible_mini_cart_low_stock_message) {
        collapsibleFields.collapsible_mini_cart_low_stock_message.render = false;
      }
      if (collapsibleFields.collapsible_mini_cart_low_stock_messageInnercontent) {
        collapsibleFields.collapsible_mini_cart_low_stock_messageInnercontent.render = false;
      }
    } // end collapsibleLowStockEnabled

    // Ensure collapsible_mini_cart_enable_saving_price_message toggle field exists (toggle field from module.json)
    if (!collapsibleFields.collapsible_mini_cart_enable_saving_price_message) {
      set(collapsibleFields, 'collapsible_mini_cart_enable_saving_price_message', {
        priority: 110,
        component: {
          name: 'divi/toggle',
          type: 'field',
        ...
        render: true,
        attrName: 'collapsible_mini_cart_enable_saving_price_message',
      ...
      collapsibleFields.collapsible_mini_cart_enable_saving_price_message.render = true;
    }

    // Only show saving price message when saving price toggle is enabled
    const collapsibleSavingEnabled = (attrs as any)?.collapsible_mini_cart_enable_saving_price_message?.desktop?.value === 'on';
    if (collapsibleSavingEnabled) {
    if (collapsibleFields.collapsible_mini_cart_saving_price_message) {
      collapsibleFields.collapsible_mini_cart_saving_price_message.render = true;
    }
    if (collapsibleFields.collapsible_mini_cart_saving_price_messageInnercontent) {
      collapsibleFields.collapsible_mini_cart_saving_price_messageInnercontent.render = true;
    }
    } else {
      if (collapsibleFields.collapsible_mini_cart_saving_price_message) {
        collapsibleFields.collapsible_mini_cart_saving_price_message.render = false;
      }
      if (collapsibleFields.collapsible_mini_cart_saving_price_messageInnercontent) {
        collapsibleFields.collapsible_mini_cart_saving_price_messageInnercontent.render = false;
      }
    } // end collapsibleSavingEnabled
    ...
    // Ensure order_summary_field_enable_strike_through_price toggle field exists (toggle field from module.json)
    if (!orderSummaryFields.order_summary_field_enable_strike_through_price) {
      set(orderSummaryFields, 'order_summary_field_enable_strike_through_price', {
        priority: 20,
        component: {
          name: 'divi/toggle',
          type: 'field',
        ...
        render: true,
        attrName: 'order_summary_field_enable_strike_through_price',
        label: 'Regular & Discounted Price',
        features: {
          sticky: false,
          dynamicContent: false,
      ...
      orderSummaryFields.order_summary_field_enable_strike_through_price.render = true;
    }

    // Ensure order_summary_field_enable_low_stock_trigger toggle field exists (toggle field from module.json)
    if (!orderSummaryFields.order_summary_field_enable_low_stock_trigger) {
      set(orderSummaryFields, 'order_summary_field_enable_low_stock_trigger', {
        priority: 30,
        component: {
          name: 'divi/toggle',
          type: 'field',
        ...
        render: true,
        attrName: 'order_summary_field_enable_low_stock_trigger',
        label: 'Low Stock Trigger',
        features: {
          sticky: false,
          dynamicContent: false,
      ...
      orderSummaryFields.order_summary_field_enable_low_stock_trigger.render = true;
    }

    // Ensure order_summary_field_low_stock_message textarea field exists (textarea field from module.json)
    // Textarea fields with innerContent are auto-loaded from module.json, but ensure render is true
    if (orderSummaryFields.order_summary_field_low_stock_message) {
      orderSummaryFields.order_summary_field_low_stock_message.render = true;
    }

    // Ensure order_summary_field_enable_saving_price_message toggle field exists (toggle field from module.json)
    if (!orderSummaryFields.order_summary_field_enable_saving_price_message) {
      set(orderSummaryFields, 'order_summary_field_enable_saving_price_message', {
        priority: 50,
        component: {
          name: 'divi/toggle',
          type: 'field',
        ...
        render: true,
        attrName: 'order_summary_field_enable_saving_price_message',
        label: 'Total Saving Message',
        features: {
          sticky: false,
          dynamicContent: false,
      ...
      orderSummaryFields.order_summary_field_enable_saving_price_message.render = true;
    }

    // Ensure order_summary_field_saving_price_message textarea field exists (textarea field from module.json)
    // Textarea fields with innerContent are auto-loaded from module.json, but ensure render is true
    if (orderSummaryFields.order_summary_field_saving_price_message) {
      orderSummaryFields.order_summary_field_saving_price_message.render = true;
    }

    // Ensure contentPaymentGateway group exists
    if (!config.contentPaymentGateway) {
    ...
    // Ensure fields object exists
    if (!config.contentPaymentGateway.component) {
      config.contentPaymentGateway.component = {
        props: {
          fields: {},
        },
      };
