	...
	public static function module_styles( array $args ): void {
		...
		if ( ! empty( $active_border_color_css ) || ! empty( $inactive_border_color_css ) || ! empty( $active_tab_border_bottom_color_css ) || ! empty( $inactive_tab_border_bottom_color_css ) || ! empty( $order_summary_divider_line_color_css ) || ! empty( $focus_color_css ) || ! empty( $validation_color_css ) || ! empty( $primary_color_extra_css ) || ! empty( $breadcrumb_hover_color_css ) || ! empty( $payment_desc_color_css ) || ! empty( $coupon_focus_color_css ) ) {
			$border_color_manual_css_entry = array_merge(
				$active_border_color_css ?? [],
				$inactive_border_color_css ?? [],
				$active_tab_border_bottom_color_css ?? [],
				$inactive_tab_border_bottom_color_css ?? [],
				$order_summary_divider_line_color_css ?? [],
				$focus_color_css ?? [],
				$validation_color_css ?? [],
				$primary_color_extra_css ?? [],
				$breadcrumb_hover_color_css ?? [],
				$payment_desc_color_css ?? [],
				$coupon_focus_color_css ?? []
			);
		}
				...
				'styles'        => [
					...
					$elements->style(
						[
							...
							'styleProps' => [
								'defaultPrintedStyleAttrs' => $default_printed_style_attrs['wfacp_collapsible_margin']['decoration'] ?? [],
							],
						]
					),
					...
					$elements->style(
						[
							...
							'styleProps' => [
								'defaultPrintedStyleAttrs' => $default_printed_style_attrs['wfacp_tab_margin']['decoration'] ?? [],
							],
						]
					),
					...
					// Breadcrumb Typography - Color (rendered BEFORE heading typography so typography's color wins by source order)
					$elements->style(
						[
					...
					// Breadcrumb Typography - Heading (includes color from divi/font group — must come AFTER breadcrumb_text_color)
					$elements->style(
						[
					...
					$elements->style(
						[
							...
							'styleProps' => ! empty( $section_border_fix ) ? [ 'advancedStyles' => $section_border_fix ] : [],
						]
					),
					...
					// Order Summary Strike Through Typography - Strike Through
					// Selector: {{selector}} #wfacp-e-form #wfacp-sec-wrapper .product-total del, ...
					$elements->style(
						[
							'attrName' => 'order_summary_strike_through_typo',
						]
					),

					// Order Summary Low Stock Typography - Low Stock Message
					// Selector: {{selector}} #wfacp-e-form #wfacp-sec-wrapper .wfacp_stocks
					$elements->style(
						[
							'attrName' => 'order_summary_low_stock_message_typo',
						]
					),

					// Order Summary Saving Text Typography - Saving Text
					// Selector: {{selector}} #wfacp-e-form #wfacp-sec-wrapper table.shop_table tr:not(.order-total):not(.cart-discount).wfacp-saving-amount td, ...
					$elements->style(
						[
							'attrName' => 'order_summary_enable_saving_price_message_typo',
						]
					),
			...
			$elements->style(
				...
				$elements->style(
					[
						...
						'styleProps' => [
							'defaultPrintedStyleAttrs' => $default_printed_style_attrs['form_background_color']['decoration'] ?? [],
						],
					]
				),
				...
				'styleProps' => ! empty( $form_border_fix ) ? [ 'advancedStyles' => $form_border_fix ] : [],
			]
		),
