	...
	class WFACP_Plugin_Compatibilities {
		...
		public static function plugin_loaded() {
			...
			$files = array(
				...
				'plugins/class-etch-builder.php'           => defined( 'ETCH_PLUGIN_DIR' ),
				...
				'plugins/class-woocommerce-extra-product-options-pro.php' => class_exists( 'THWEPO_Public' ),
		...
		public static function setup_theme() {
			$files = array(
				...
				'themes/class-theme-impreza.php'           => defined( 'US_ACTIVATION_THEMENAME' ),
		...
		public static function add_files( $paths ) {
			try {
				...
				if ( defined( 'BWF_DEV' ) && true === BWF_DEV ) {
					trigger_error( esc_html( $e->getMessage() ) ); // phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_trigger_error -- Development debugging when BWF_DEV is enabled
				}
			}
		}
	}
