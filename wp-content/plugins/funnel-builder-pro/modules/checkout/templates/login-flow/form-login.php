	...
	<div class="wfacp-login-wrapper">
		...
		<p class="form-row wfacp-form-control-wrapper wfacp-col-full wfacp-input-form validate-required">
			...
			<span class="woocommerce-input-wrapper">
					<input type="text" class="input-text wfacp-form-control" name="username" id="username" autocomplete="username" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( wp_unslash( $_POST['username'] ) ) : ''; ?>" placeholder="<?php esc_attr_e( 'Username or email address', 'woocommerce' ); ?>"/>
			</span>
		...
		<p class="form-row wfacp-form-control-wrapper wfacp-col-full wfacp-input-form validate-required wfacp-password-field">
			...
			<span class="woocommerce-input-wrapper">
			<input class="input-text wfacp-form-control" type="password" name="password" id="password" autocomplete="current-password" placeholder="<?php esc_attr_e( 'Password', 'woocommerce' ); ?>"/>
		...
		<p class="form-row wfacp-form-control-wrapper wfacp-login-button wfacp-col-full">
			...
			<input type="hidden" name="funnelkit_login" value="1"/>
			<input type="hidden" name="redirect" value="<?php echo esc_url( isset( $_SERVER['REQUEST_URI'] ) ? wp_sanitize_redirect( wp_unslash( $_SERVER['REQUEST_URI'] ) ) : '' ); ?>"/>
