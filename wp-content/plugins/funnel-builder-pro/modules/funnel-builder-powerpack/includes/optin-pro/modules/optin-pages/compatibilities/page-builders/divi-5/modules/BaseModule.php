<?php
/**
 * Base Module Class for WFOPP Divi 5 Modules (Optin Pro).
 *
 * This abstract class provides a reusable pattern for all WFOPP modules,
 ...
 *
 * All WFOPP Divi 5 modules should extend this class.
...
abstract class BaseModule implements DependencyInterface {
	...
	/**
	 * Module name (e.g., 'OptinFormPopup').
	 *
	 * @since 1.0.0
	 * @var string
	 */
	...
	/**
	 * Module namespace (e.g., 'WFOPP\Modules\OptinFormPopup').
	 *
	 * @since 1.0.0
	 * @var string
	 */
