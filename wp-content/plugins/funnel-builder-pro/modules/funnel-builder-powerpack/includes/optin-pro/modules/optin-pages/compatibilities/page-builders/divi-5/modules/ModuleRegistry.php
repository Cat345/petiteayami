<?php
/**
 * Module Registry for WFOPP Divi 5 Modules (Optin Pro).
 *
 * This class provides a centralized way to register and manage all WFOPP modules.
 * It automatically discovers and loads modules based on configuration.
 *
 * @package WFOPP\Modules
 * @since 1.0.0
 */

namespace WFOPP\Modules;
 ...
 *
 * Manages registration of all WFOPP Divi 5 modules.
 *
 * @since 1.0.0
 */
class ModuleRegistry {
	 ...
	 * [
	 *   'module_name' => [
	 *     'namespace' => 'WFOPP\Modules\ModuleName',
	 *     'class'     => 'ModuleName',
	...
	private static $modules = array(
		'OptinFormPopup' => array(
			'namespace' => 'WFOPP\Modules\OptinFormPopup',
			'class'     => 'OptinFormPopup',
			'dir'       => 'OptinFormPopup',
		),
	);
